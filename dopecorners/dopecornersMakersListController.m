...
#include "dopecornersMakersListController.h"
...
@implementation dopecornersMakersListController

- (NSArray *)specifiers {
    if (!_specifiers) {
        _specifiers = [[self loadSpecifiersFromPlistName:@"dopecornersMakersListController" target:self] retain];
    }
    return _specifiers;
}
...
-(NSString*)imageName { return @"Wizages.png"; }
@end
...
-(NSString*)imageName { return @"Buzzeh.png"; }
@end